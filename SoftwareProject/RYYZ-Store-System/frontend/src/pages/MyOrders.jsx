...
import { generateInvoicePDF } from '../utils/pdfGenerator';import './MyOrders.css';
        ...
        <div className="order-modal-backdrop" onClick={() => setSelectedOrder(null)}>
          <div className="order-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              {/* ✅ FIXED: Pass full selectedOrder object */}
              <button className="btn-download-full" onClick={() => handleDownloadInvoice(selectedOrder)}>
